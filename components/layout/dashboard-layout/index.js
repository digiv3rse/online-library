...
const initTabs = [
 {label: 'Fashion', value: 'fashion', path: '/{collection}'},
 {label: 'Art', value: 'art', path: '/{collection}'},
 {label: 'Fiction', value: 'fiction', path: '/{collection}'},
 {label: 'Non-Fiction', value: 'non-fiction', path: '/{collection}'},
 {label: 'Syfy', value: 'syfy', path: '/{collection}'},
 {label: 'Biography', value: 'biography', path: '/{collection}'}
]
